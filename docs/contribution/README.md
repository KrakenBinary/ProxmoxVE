...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/KrakenBinary/ProxmoxVE → Fork (top right)
...
git remote add upstream https://github.com/KrakenBinary/ProxmoxVE.git
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/KrakenBinary/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/KrakenBinary/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/KrakenBinary/ProxmoxVE/discussions)
