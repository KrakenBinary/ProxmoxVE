...
# upstream   https://github.com/KrakenBinary/ProxmoxVE.git (fetch)
# upstream   https://github.com/KrakenBinary/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/KrakenBinary/ProxmoxVE"
echo ""
