...
function update_script() {
  ...
  msg_error "For more details, see: https://github.com/KrakenBinary/ProxmoxVE/issues/11406"
  exit 1

  if [[ $(grep -E '^VERSION_ID=' /etc/os-release) == *"12"* ]]; then
    msg_error "Wrong Debian version detected!"
    msg_error "Please create a snapshot first. You must upgrade your LXC to Debian Trixie before updating. Visit: https://github.com/KrakenBinary/ProxmoxVE/discussions/7489"
    exit
  fi
